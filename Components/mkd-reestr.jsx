...
const MkdReestr = ({ mkdObj, jkhObj }) => {
  ...
  const paramInfo = {
    ...
    'Площадь дома:': `${area_total} кв.м.`,
    'Общая площадь квартир:': `${area_residential} кв.м.`,
    'Общая площадь нежилых помещений:': `${area_non_residential} кв.м.`,
    'Площадь парковки:': `${parking_square} кв.м.`,
    'Детская площадка:': `${playground} кв.м.`,
    'Спортивная площадка:': `${sportsground} кв.м.`,
  ...
  const paramInfoJkh = {
    ...
    'Общая площадь объектов под управлением:': jkhInfo?.areaTotalJkh,
